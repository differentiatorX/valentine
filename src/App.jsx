...
export default function Page() {
  ...
  const getNoButtonText = () => {
    const phrases = [
      ...
      "I'll do your assignments! 📚✍️",
      "We can bunk classes together! 🤫✨",
      "Late night maggi dates? 🍜🌙",
      "I'll be your study buddy! 🤓📖",
      "Campus walks with you? 🌳🚶‍♂️",
      "I'll buy you canteen treats! 🍔🍟",
      "You're the prettiest on campus! 🏫💖",
      "Let's make the best college memories! 🎓📸",
      "Pretty pretty please? 🥺👉👈",
      "I'll do anything for you! 🧞‍♂️💖",
      "You are my queen, Shweta! 👑✨",
      "Don't ignore my love! 📢🥺",
      "I'm on my knees begging! 🧎‍♂️🥺",
      "You're the cheese to my macaroni! 🧀🍝",
      "Change your mind, Shweta? 🧠💡",
      "Jenny, you're my everything! 🌍💖",
